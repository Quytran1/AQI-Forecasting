...
def create_time_series_dataloader(X, y, batch_size=32, shuffle=True):
...
if __name__ == "__main__":
    data_train = np.load("data\Dataset_India\Bengaluru_train.npz")
    data_test = np.load("data\Dataset_India\Bengaluru_test.npz")
